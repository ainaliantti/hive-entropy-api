...
float Hardware::getProcessorCoreNumber() const { return processorCoreNumber; }

float Hardware::getProcessorFrequency() const { return processorFrequency; }

float Hardware::getProcessorOccupation() const { return processorOccupation; }

float Hardware::getRamSize() const { return ramSize; }

float Hardware::getRamOccupation() const { return ramOccupation; }

int Hardware::getRate() const {
  return (ramSize * ramOccupation / 100 +
          processorCoreNumber * processorOccupation / 100) *
         10 / 16;
}
